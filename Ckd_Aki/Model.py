...
df = pd.read_csv("Ckd_Aki/kidney_disease_classification_updated.csv")
...
with open('Ckd_Aki/kidney_disease_voting_model.pkl', 'wb') as model_file:
    pickle.dump(voting_clf, model_file)    

# Save the LabelEncoder as well
with open('Ckd_Aki/label_encoder.pkl', 'wb') as le_file:
